                    ...
                    <form class="card login-form" action="{{ route('login') }}" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="social-login">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-12"><a class="btn twitter-btn"
                                            href=""><i class="lni lni-twitter-original"></i> Twitter
                                            login</a></div>
                            ...
                            <div class="form-group input-group">
                                ...
                                <input class="form-group input-group" type="text" name="{{ config('fortify.username') }}" id="reg-email" required>
                            </div>
                            <div class="form-group input-group">
                                <label for="reg-fn">Password</label>
                                <input class="form-group input-group" type="password" name="password" id="reg-pass" required>
                            </div>
